...
namespace WindowsFormsApp1.sve
{
    internal class Kalendar : DateTimePicker
    {
        private Color skinColor = Color.LightGray;
        private Color textColor = Color.Black;
        private Color borderColor = Color.LightGray;
        private int borderSize = 0;

        private bool droppedDown = false;
        private Image calendarIcon = Properties.Resources.ccccc;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.ccccc;
                else calendarIcon = Properties.Resources.ccccc;
                this.Invalidate();
            }
        }
